...
// file is uploaded successfully
                                                ...
                                                $this->copygallery($id, $model->id, 'gallery_large');
                                                $this->rename($model->id, $model->canonical_name, 'gallery');
                                                $this->rename($model->id, $model->canonical_name, 'gallery_large');
                                        }
...
//            mkdir(\Yii::$app->basePath . '/../uploads/product/' . $id . '/gallery/', 0644, true);
                ...
                if (!is_dir(\Yii::$app->basePath . '/../uploads/product/' . $id . '/gallery_large/')) {
                        mkdir(\Yii::$app->basePath . '/../uploads/product/' . $id . '/gallery_large/', 0777, true);

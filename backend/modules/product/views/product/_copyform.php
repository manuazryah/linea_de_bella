        ...
        <div class="tab-pane active" id="general">
            <div class="row" style="margin: 0 auto; padding: 15px 15px;">
                ...
                <div class='col-md-6 col-sm-6 col-xs-12 '>
                    <?= $form->field($model, 'profile')->fileInput()->label('profile Picture<i> (455*400)</i>') ?>
                    <?php
                    if (!$model->isNewRecord) {
                ...
                <div class='col-md-6 col-sm-6 col-xs-12 '>
                    <?= $form->field($model, 'other_image[]')->fileInput(['multiple' => true, 'accept' => 'image/*'])->label('Gallery Images<i> (455*400)</i>') ?>

                            ...
                            <ul>
                                ...
                                if (!empty($sliders)) {
                                    ...
                                    foreach ($sliders as $slider) {
                                        ...
                                        ?>
                                        <li data-index="rs-<?= $i ?>" data-transition="slotzoom-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="Linear.easeNone" data-easeout="Linear.easeNone" data-masterspeed="default" data-thumb="" data-rotate="8" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                            <img src="<?= Yii::$app->homeUrl; ?>uploads/cms/slider/<?= $slider->id ?>/large.<?= $slider->img ?>" alt="<?= $slider->alt_tag_content != '' ? $slider->alt_tag_content : '' ?>" width="1920" height="972" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                        </li>
                                        <?php
                                    }
                                }
                        ...
                        <div class="maxFullHTML">
                            <div class="maxHTMLContent layout-one">
                                <div class="maxCaption">
                                    <div class="content">
                                        <h3 class="title"><?= $our_collection->title ?></h3>
                                        <div class="desc"><?= strlen($our_collection->description) > 225 ? substr($our_collection->description, 0, 225) . ".." : $our_collection->description ?></div>
                                    </div>
                                    <div class="more">
                                        <a class="htmlMore" href="<?= $our_collection->link ?>" title="Men Collection">M<br>
                                            o<br>
                                            r<br>
                                            e</a>
                                    </div>
                                ...
                                <div class="maxBanner">
                                    <div class="bingoBanner">
                                        <div class="effectThree"> <a href="" title="<?= $our_collection->title ?>">
                                                <img class="img-responsive" src="<?= Yii::$app->homeUrl; ?>uploads/cms/our_collections/<?= $our_collection->id ?>/large.<?= $our_collection->image ?>" alt="<?= $our_collection->title != '' ? $our_collection->title : '' ?>"> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="maxFullHTML">
                            <div class="maxHTMLContent layout-two">
                                <div class="maxCaption">
                                    <div class="content">
                                        <h3 class="title"><?= $our_collection->title ?></h3>
                                        <div class="desc"><?= strlen($our_collection->description) > 420 ? substr($our_collection->description, 0, 420) . ".." : $our_collection->description ?></div>
                                    </div>
                                    <div class="more">
                                        <a class="htmlMore" href="<?= $our_collection->link ?>" title="WoMen Collection">M<br>
                                            o<br>
                                            r<br>
                                            e</a>
                                    </div>
                                ...
                                <div class="maxBanner">
                                    <div class="bingoBanner">
                                        <div class="effectThree"> <a href="#" title="Line De Bella Women">
                                                <img class="img-responsive" src="<?= Yii::$app->homeUrl; ?>uploads/cms/our_collections/<?= $our_collection->id ?>/large.<?= $our_collection->image ?>" alt="<?= $our_collection->title != '' ? $our_collection->title : '' ?>"> </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    if (!empty($latest_updates)) {
                                        foreach ($latest_updates as $latest_update) {
                                            ...
                                            <article class="item-post ">
                                                <div class="time-post ">
                                                    <p><?= date('d', strtotime($latest_update->date)); ?><span><?= date('M', strtotime($latest_update->date)); ?></span></p>
                                                </div>
                                                <a href=" " title="<?= $latest_update->title ?>">
                                                    <h2><?= $latest_update->title ?></h2>
                                                </a>
                                                <div class="content ">
                                                    <p><?= strlen($latest_update->description) > 300 ? substr($latest_update->description, 0, 300) . ".." : $latest_update->description ?></p>
                                                </div>
                                            </article>
                                            <?php
                                        }
                                ...
                                <div class="axis_tile_image">  <a href="mens-product.php" data-wt-events="mousedown" class="">
                                        <div class="image_layer" style="border-color: #D7D7D7;">
                                            <div class="headlines_container right">
                                                <div class="sub_headline_2" style="color: #b78d2e;"><?= $shop_collection->sub_title ?></div>
                                                <div class="headline_2" style="color: #FFFFFF;"><?= $shop_collection->title ?></div>
                                                <a href="<?= $shop_collection->link ?>"><div class="promo_btn notpropagate" data-wt-events="mousedown">SHOP NOW</div></a>
                                            </div>
                                            <img style="height: 100%;" src="<?= Yii::$app->homeUrl; ?>uploads/cms/shop_collections/<?= $shop_collection->id ?>/large.<?= $shop_collection->image ?>" alt="<?= $shop_collection->title != '' ? $shop_collection->title : '' ?>"> </div>
                                    </a> </div>
                            </div>
                        <?php } elseif ($shop_collection->id == 2) {
                            ?>
                            <div class="axis-tile-box-s L-3">
                                <div class="axis_tile_image">  <a href="" data-wt-events="mousedown">
                                        <div class="image_layer" style="border-color: #D7D7D7;">
                                            ...
                                            <img src="<?= Yii::$app->homeUrl; ?>uploads/cms/shop_collections/<?= $shop_collection->id ?>/large.<?= $shop_collection->image ?>" alt="<?= $shop_collection->title != '' ? $shop_collection->title : '' ?>"> </div>
                                    </a> </div>
                            </div>
                        <?php } elseif ($shop_collection->id == 3) {
                            ?>
...
<section class="home-special-offers">
    <div class="block double-parallax">
        <div class="parallax-container"><div data-speed="1" data-bleed="12" class="parallax parallax1"><img src="" alt="" style="display: block; transform: translate3d(-50%, 0px, 0px);"></div></div>
        <div class="parallax-container"><div data-speed="0.4" class="parallax parallax2"><img src="" alt="" style="display: block; transform: translate3d(-50%, 0px, 0px);"></div></div>
        <div class="container">
            <div class="row">

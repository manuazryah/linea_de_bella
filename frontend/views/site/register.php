    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="content" class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <p>If you already have an account with us, please login at the <a href="login-up.php">login page</a>.</p>
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <fieldset id="address">
                        <h3 class="title2">Your Address</h3>
                        <div class="form-group">
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <select name="country_id" id="input-country" class="form-control hasCustomSelect" style="-webkit-appearance: menulist-button; width: 723px; position: absolute; opacity: 0; height: 34px; font-size: 12px;">

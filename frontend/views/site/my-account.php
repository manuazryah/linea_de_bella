    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="content" class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                ...
                <p>Hello 
                    <strong>vishalramesh61994</strong> (not 
                    <strong>vishalramesh61994</strong>? 
                    <a href="">Log out</a>)
                </p>
                <p>From your account dashboard you can view your 
                    <a href="order-history.php">recent orders</a>, manage your 
                    <a href="address.php">shipping and billing addresses</a> and 

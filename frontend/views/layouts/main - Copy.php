...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <link href="<?= yii::$app->homeUrl; ?>css/jquery-sakura.css" rel="stylesheet" type="text/css">
...
<script>
  ...
  fbq('init', '161446101170528');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=161446101170528&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
  ...
  fbq('track', 'CompleteRegistration');
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-109843733-1"></script>
        <script>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3  col-sm-3 col-xs-3 left">
                            <?= Html::a('<button class="top-green">Create Your Own</button>', ['/site/index']) ?>
                            <?php // Html::a('<button class="top-green">Create Your Own</button>', ['/create_your_own/create-your-own/index']) ?>
...
<!--                                    <li class="dropdown hidden-lg hidden-md hidden-sm"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="truck"></i></a>
            ...
            <div id="header">
               <div class="gif"><img class="img-responsive" src="<?= yii::$app->homeUrl; ?>images/banner/valentines.gif"/></div>
                <div class="container">
                    <div class="row">
...
//$category_main = $_GET['category'];
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <?php if (!empty($prod_main_catag)) { ?>
                                        ...
                                        <li class="<?= $prod_main_catag->main_category == 2 ? 'active' : '' ?>"><?= Html::a('<span>Brands</span>', ['/product/index', 'category' => 'brands', 'featured' => 'featured'], ['class' => '']) ?></li>
                                        <?php
                                    } else {
                                        ?>
                                        <li class=""><?= Html::a('<span>Exclusive Brands</span>', ['/product/index', 'id' => $catag->category_code], ['class' => '']) ?></li>
                                        <li class=""><?= Html::a('<span>Brands</span>', ['/product/index', 'category' => 'brands', 'featured' => 'featured'], ['class' => '']) ?></li>
                                    <?php } ?>
...
<li><?= Html::a('<span>Return Policy</span>', ['/site/payment-policy'], ['class' => '']) ?></li>
...
s1.async=true;
s1.src='https://embed.tawk.to/5a798b7bd7591465c7076aa2/default';
s1.charset='UTF-8';
    ...
    var onloadCallback = function () {
        ...
        $('.g-recaptcha').each(function (i, captcha) {
            grecaptcha.render(captcha, {
                'sitekey': '6LeDkzkUAAAAAJ41OcA2zqVF_9vujRoO8GUQfQMa'
            });
        });
    };
</script>

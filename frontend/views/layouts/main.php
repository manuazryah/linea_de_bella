                                                                ...
                                                                <div class="dropdown">
                                                                        ...
                                                                        <ul class="dropdown-menu  animated2 fadeInUp">
                                                                                <?php if (!empty(Yii::$app->user->identity)) { ?>
                                                                                        ...
                                                                                        . Html::submitButton(
                                                                                                'Logout', ['style' => 'background: white;border: none;']
                                                                                        ) . '</a>'
                                                                                        . Html::endForm()
                                                                                        . '</li>';
                                                                                        ?>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-3  col-sm-4">
                                                        <div class="f-location"> <i class="fa fa-map-marker-alt"></i>
                                                                <h4 class="head">Silkegade 13, 1113 Copenhagen K Denmark</h4>
                                                        </div>
                                                </div>
                                                <div class="col-md-3  col-sm-4">
                                                        <div class="f-location"> <i class="fas fa-phone-volume"></i>
                                                                <h4 class="head">055 6478 022</h4>
                                                        </div>
                                                </div>
                                                <div class="col-md-3  col-sm-4">
                                                        <div class="f-location"> <i class="fas fa-envelope"></i>
                                                                <h4 class="head">info@lineadebella.com</h4>
                                                        </div>
                                                </div>
                                        </div>
                                </div>

                ...
                <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 product-img-view-box">
                                ...
                                <div class="app-figure showloader disabledbutton" id="zoom-fig">
                                        ...
                                        if (file_exists($product_image)) {
                                                ...
                                                <a id="Zoom-1" class="MagicZoom" title="" href="<?= Yii::$app->homeUrl . 'uploads/product/' . $product_details->id . '/profile/' . $product_details->canonical_name . '_big.' . $product_details->profile ?>">
                                                        ...
                                                        <?php
                                                        if ($product_details->offer_price != "0" && !empty($product_details->offer_price && $product_details->price > $product_details->offer_price)) {
                            ...
                            ?>
                                        ...
                                        <div class="selectors showloader disabledbutton ">
                                                <?php
                                                if (file_exists($product_image)) {
                                                        ?>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 details">
                                ...
                                <div class="hr-box">
                                        ...
                                        <?php if (isset($product_details->brand)) { ?>
                                                <h5 class="type">Brand:
                                                        <?php $brand = \common\models\Brand::findOne($product_details->brand); ?>
                                                        <span class="not-available active-box" data-toggle="tooltip" title="" style="border: none !important;"><?= $brand->brand; ?></span>
                                                </h5>
                                        <?php } ?>
                                </div>

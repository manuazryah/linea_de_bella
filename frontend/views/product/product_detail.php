        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="products-details-box">
                    <h1 class="head"><?= ucwords(strtolower($product_details->product_name)) ?></h1>
                    <ul class="list">
                        <?php
                        ...
                        <?php
                        if (isset($product_details->gender_type) && $product_details->gender_type != '') {
                            ...
                            ?>
                            <li>Targeted Group:   <?= $gender; ?>  </li>
                            <?php
                        }
                        ?>

                        <?php
                        if (isset($product_details->brand) && $product_details->brand != '') {
                            $brand = \common\models\Brand::findOne($product_details->brand);
                            if (!empty($brand)) {
                                ?>
                                <li>Collection:   <?= $brand->brand; ?></li>
                                <?php
                            }
                        }
                        ?>
                    ...
                    <a href="#" data-product-id="<?= $product_details->id ?>" class="product-addto-cart add-cart" pro_id="<?= $product_details->canonical_name ?>">Add to Cart</a>

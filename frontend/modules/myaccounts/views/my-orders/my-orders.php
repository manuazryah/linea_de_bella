...
<?php if ($model->status != 5) { ?>
            <?= Html::a('<i class="fa fa-ban" aria-hidden="true"></i>Cancel', ['/myaccounts/my-orders/cancel-order', 'id' => $model->order_id], ['class' => 'track-btn','onclick'=>"return confirm('Are you sure want to cancel the Order?');"]) ?>
<?php } ?>       
 </div>
        <?php
...
<div class="hidden-lg hidden-md hidden-sm col-xs-12">
    <div class="orders-box col-xs-12">
        <div class="track">
            ...
            <?= Html::a('<i class="fa fa-ban" aria-hidden="true"></i>', ['/myaccounts/my-orders/cancel-order', 'id' => $model->order_id], ['class' => 'track-btn','onclick'=>"return confirm('Are you sure want to cancel the Order?');", 'title' => 'Cancel Your Product']) ?>
        </div>
        <?php
        foreach ($order_products as $order_product) {
            if ($order_product->item_type == 1) {
